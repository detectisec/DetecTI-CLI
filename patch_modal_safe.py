...
html = re.sub(r"graph\.js\?v=\d+", "graph.js?v=69", html)
...
out_lines = []
in_showContextMenu = False

for line in js_lines:
    if "showContextMenu(node, x, y) {" in line:
        in_showContextMenu = True
        
    if in_showContextMenu and "const collapseActions = [];" in line:
        out_lines.append(line)
        # Inject our logic right after initializing the array
        inject = """
